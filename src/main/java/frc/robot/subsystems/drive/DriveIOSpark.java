...
public class DriveIOSpark implements DriveIO {
    ...
    public DriveIOSpark() {
        ...
        // Apply config to leaders (will run configurations until it is applied, ensuring configs are properly applied)
        ...
        // Apply config to followers (same proccess as lead motors)
