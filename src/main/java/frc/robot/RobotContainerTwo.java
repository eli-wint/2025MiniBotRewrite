...
public class RobotContainerTwo {
    ...
    // Will using the same controller for different tasks cause an error?
    private final FlipperCommand flipperJoystick = new FlipperCommand(flipperSubsystem, driverController::getLeftY);
